...
export default function MdproEditor({ selectedFile, content, binaryContent, fmaImportBatch, loading, explorerWidth, onSave, onSaveAs, onSaveImageToFolder, onClose, onToggleExplorer, onOpenExplorer, onOpenFolderExplorer, onThemeChange }) {
  ...
  const callbacksRef = useRef({ onSave, onSaveAs, onSaveImageToFolder, onToggleExplorer, onOpenExplorer, onOpenFolderExplorer, onThemeChange });
  ...
  useEffect(() => { callbacksRef.current = { onSave, onSaveAs, onSaveImageToFolder, onToggleExplorer, onOpenExplorer, onOpenFolderExplorer, onThemeChange }; }, [onSave, onSaveAs, onSaveImageToFolder, onToggleExplorer, onOpenExplorer, onOpenFolderExplorer, onThemeChange]);
  ...
  useEffect(() => {
    const handleMessage = (event) => {
      ...
      if (event.source === mdproFrameRef.current?.contentWindow) {
        ...
        if (event.data.type === 'webdav-save-document') callbacksRef.current.onSave(String(event.data.content ?? ''), event.data.path);
